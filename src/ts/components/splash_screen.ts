...
const splash = function () {
  ...
  box.setAttribute(
    "style",
    "width:600px;height: 150px;margin-left:auto;margin-right:auto;"
  );
...
//   const userLocal = localStorage.getItem("userlocal");
  if (!userLocal) {
    ...
    box_msg.setAttribute(
      "style",
      "width:900px;height:250px;margin-left:auto;margin-right:auto;margin-top:-60px;"
    );
