...
export function calcularChurras(man, wom, kid, tim, atv) {
    let totMeat = valueDefaultChurras.meat.man.picanha * man * 1 * (1);
    ...
    let totChicken = valueDefaultChurras.chicken.man.drummets * man * 1 * (1);
    ...
    let totSausage = valueDefaultChurras.sausage.man.apimentada * man * 1 * (1);
    ...
    let totPork = valueDefaultChurras.pork.man.costelinha * man * 1 * (1);
