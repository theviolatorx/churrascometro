...
const splash = function() {
    ...
    const box_msg = document.createElement('div') as HTMLDivElement;
    ...
    h3.innerHTML = "O Churrascometro foi desenvolvido para simplificar e aprimorar a experiência de planejar churrascos. Desde calcular a quantidade certa de carne por pessoa até sugerir os melhores cortes e acompanhamentos, estamos aqui para garantir que cada churrasco seja um sucesso.<br>";
    h3.innerHTML = h3.innerHTML + "Para aproveitar ao máximo o Churrascometro, é fácil começar. Basta se cadastrar para desbloquear todas as funcionalidades exclusivas. Com sua conta, você poderá salvar suas preferências, histórico de churrascos e até mesmo receber sugestões personalizadas com base nas suas escolhas anteriores.<br>";
    h3.innerHTML = h3.innerHTML + "Registre-se agora e descubra como o Churrascometro pode tornar seus churrascos mais simples, saborosos e inesquecíveis. É hora de transformar cada churrasco em uma celebração única!<br><br>";
